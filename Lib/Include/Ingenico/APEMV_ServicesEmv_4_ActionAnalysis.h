...
#ifndef APEMV_SERVICES_EMV_ACTION_ANALYSIS_H_INCLUDED
#define APEMV_SERVICES_EMV_ACTION_ANALYSIS_H_INCLUDED
...
#endif // APEMV_SERVICES_EMV_ACTION_ANALYSIS_H_INCLUDED
