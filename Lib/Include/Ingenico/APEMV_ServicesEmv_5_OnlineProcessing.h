...
#ifndef APEMV_SERVICES_EMV_ONLINE_PROCESSING_H_INCLUDED
#define APEMV_SERVICES_EMV_ONLINE_PROCESSING_H_INCLUDED
...
#endif // APEMV_SERVICES_EMV_ONLINE_PROCESSING_H_INCLUDED
